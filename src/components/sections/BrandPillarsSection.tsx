    ...
    <section className="bg-gradient-to-r from-[#4A126D] via-[#7B1FA2] to-[#E91E63] text-white py-16 lg:py-20 relative overflow-hidden shadow-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          {/* Left Column: Heading & 4 Circular Icon Badges (matching Reference Image 4) */}
          ...
          {/* Right Column: Reference Woman Sitting Cross-Legged Image (matching Reference Image 4) */}
          <div className="lg:col-span-4 relative flex justify-center">
            ...
            <div className="relative z-10 w-64 sm:w-80">
              <img
                src="/images/brand-woman.png"
                alt="Smiling woman in striped shirt sitting cross-legged"
