    ...
    <section className="py-20 bg-white overflow-hidden relative border-b border-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          {/* Left Column: Quote Text + Flying Butterfly Accent (matching Reference Image 3) */}
          ...
          <div className="lg:col-span-4 relative flex justify-center">
            <div className="w-full max-w-xs rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
              <img
                src="/images/uti-woman.jpg"
                alt="Woman outdoors raising arms holding HaPee product box"
                className="w-full h-auto object-cover transform hover:scale-105 transition-transform duration-700"
              />
            </div>
          </div>

          {/* Right Column: Purple-to-Magenta Gradient Card (matching Reference Image 3) */}
          <div className="lg:col-span-4">
            <div className="bg-gradient-to-br from-[#4A126D] via-[#7B1FA2] to-[#E91E63] text-white rounded-3xl p-8 sm:p-10 shadow-2xl space-y-5 transform hover:scale-102 transition-transform duration-300">
              <div className="space-y-2">
                <h3 className="text-3xl font-bold tracking-tight">Pee Device</h3>
                <div className="w-12 h-1 bg-pink-300 rounded-full" />
                <p className="text-sm font-semibold text-pink-100 uppercase tracking-wider pt-1">
              ...
              <div className="pt-1">
                <img
                  src="/images/ha-pee-box.png"
                  alt="HaPee Box Graphic"
                  className="w-full max-w-[200px] h-auto object-contain mx-auto drop-shadow-md pb-2"
                />
